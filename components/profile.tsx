...
export default function ProfileCard({
  ...
  return (
    <div className="flex w-full justify-center xl:justify-start">
      <div className="sticky top-8 w-full max-w-xl rounded-[30px] bg-[#f7f2fe] dark:bg-purple-950/20 px-8 py-10 shadow-sm border border-purple-50 dark:border-purple-900/30">
        <div className="relative mx-auto mb-10 size-28">
          <div className="size-full overflow-hidden rounded-full border-4 border-white dark:border-slate-800 bg-[#d9d9d9] dark:bg-slate-700 shadow-sm">
            {user?.imageUrl ? (
              <img
                src={user.imageUrl}
                alt={user.fullName}
        ...
        {isLoading || !user ? (
          ...
          <div className="flex flex-col gap-5">
            {[
              ...
              { label: "Matric No.", val: user.matric },
              { label: "Student Email", val: user.email },
